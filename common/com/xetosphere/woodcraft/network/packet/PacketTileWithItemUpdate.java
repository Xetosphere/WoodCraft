package com.xetosphere.woodcraft.network.packet;
...
public class PacketTileWithItemUpdate extends PacketWC {
	...
	public void execute(INetworkManager manager, Player player) {
		...
		WoodCraft.proxy.handleTileWithItemPacket(x, y, z, ForgeDirection.getOrientation(orientation), state, customName, itemID, metaData, stackSize, color);
	}
